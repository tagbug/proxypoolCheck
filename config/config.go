...
type ConfigOptions struct {
	...
	ServerMaxRetry        int      `json:"server_max_retry" yaml:"server_max_retry"`
	HealthCheckTestSite   string   `json:"healthcheck_test_site" yaml:"healthcheck_test_site"`
}
...
func Parse(path string) error {
	...
	if Config.ServerMaxRetry == 0 {
		Config.ServerMaxRetry = 5
	}
	if Config.HealthCheckTestSite == "" {
		Config.HealthCheckTestSite = "https://youtube.com"
	}
	return nil
}
